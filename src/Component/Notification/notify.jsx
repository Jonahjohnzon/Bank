...
const Notify = ({Drop,info}) => {
  ...
  const Send=async()=>{
    const info={
      ...
      const data=await fetch(`https://heritag.onrender.com/notifypanel/${userid}`,{
        method:'PUT',   
        headers:{
  ...
  return (
    <motion.div initial="start" animate="flow" variants={Slide} className='fixed z-30  w-[300px] h-[70vh] border-[1px] border-r-0 border-gray-400 bg-white rounded-lg shadow-lg bottom-1 right-0 overflow-y-scroll'>
